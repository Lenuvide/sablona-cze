...
%	language={Matlab},		% Matlab
    ...
    {Ý}{{\'Y}}1
    {Ž}{{\v{Z}}}1,    
    keywordstyle=\color{blue}\bfseries,  % klíčová slova
    commentstyle=\color[rgb]{0,0.45,0},           % komentáře #
    stringstyle=\color{teal},            % řetězce "..."
    numberstyle=\tiny\color{gray},       % číslování řádků (volitelné)
...
\usepackage{floatrow} %tabulka a obrazek v jednom řádku
...
\include{text/1_inventura}
\include{text/2_dosavadni_metody_mereni}
\include{text/3_vypocet_objemu}
\include{text/4_seriova_komunikace}
\include{text/5_nove_navrzeny_system}
\include{text/6_zprovozneni_jednotlivych_komponent}
\include{text/7_vyvoj_firmwaru}
\include{text/8_testovani}
\include{text/9_inovace}
%\include{text/404) test}
